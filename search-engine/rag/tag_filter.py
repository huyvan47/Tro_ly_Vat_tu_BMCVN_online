...
PRODUCT_ALIASES = {
    ...
    "abamectin-3-6-duc": ["thuoc abamectin 3 6 duc", "thuoc diet sau abamectin", "thuoc abamectin"],
    "abinsec": ["thuoc abinsec", "abinsec"],
    "abinsec-1-8ec": ["thuoc abinsec 1 8ec", "abinsec 1.8ec", "abinsec 1.8", "thuoc abinsec 1.8ec "],
    "abinsec-emaben-sau-1-8ec": ["thuoc abinsec emaben sau 1 8ec"],
    "abinsec-oxatin-1-8ec": ["thuoc abinsec oxatin 1 8ec", "oxatin", "abinsec oxatin", "thuoc abinsec oxatin"],
    "abinsec-sieu-diet-nhen": ["thuoc abinsec diet nhen sieu toc", "sieu diet nhen", "abinsec nhen"],
    "aco-one-40ec": ["thuoc aco one 40ec", "aco one", "aco one 40ec"],
    ...
    "binhfos-50ec-vua-ray-rep": ["thuoc diet ray rep binhfos 50ec", "vua ray rep"],
    "binhfos-50ec-vua-sau": ["thuoc diet sau binhfos 50ec vua", "vua sau"],
    "binhfos-anh-hung-sau": ["thuoc diet sau binhfos anh hung", "anh hung sau"],
    ...
    "chitin-daphamec-3-6": ["thuoc diet sau chitin daphamec 3 6", "chitin daphamec", "chitin", "chitin 3.6"],
    "chlorfena-240sc": ["thuoc diet sau chlorfena 240sc", "chlorfena"],
    "chowon-550sl": ["thuoc diet sau chowon 550sl", "chowon"],
    "chowon-550sl-than-duoc": ["thuoc diet sau chowon 550sl than duoc", "chowon", "than duoc"],
    ...
    "diet-nhen-sam-set": ["thuoc diet nhen sam set", "diet nhen sam set"],
    ...
    "em-oil-99ec-spray": ["thuoc em oil 99ec xit", "em oil", "em-oil"],
    ...
    "fuji-boss-30sc": ["thuoc fuji boss 30sc", "fuji boss", "boss", "fuji"],
    "fujiboss-30sc": ["thuoc fuji boss 30sc", "fujiboss"],
    ...
    "hosu-10sc": ["thuoc bao ve thuc vat ho su 10sc", "thuoc ho su 10sc", "hosu-10sc", "hosu10sc", "hosu"],
    ...
    "kajio-5wg": ["thuoc bao ve thuc vat kajio 5wg", "thuoc kajio 5wg", "kajio 5wg", "kajio-5wg"],
    ...
    "kenbast-15sl": ["thuoc bao ve thuc vat kenbast 15sl", "kenbast 15sl", "kenbast-15sl"],
    ...
    "kyodo-25sc-gold": ["thuoc bao ve thuc vat kyodo 25sc gold", "thuoc kyodo 25sc gold", "kyodo-gold", "kyodo gold"],
    ...
    "oc-15gr": ["oc 15 gr", "thuoc oc 15 gr", "oc 15gr"],
    "oc-ly-tieu-long-18gr": ["oc ly tieu long 18 gr", "thuoc oc ly tieu long 18 gr", "oc ly tieu long", "ly tieu long 18gr"],
    "ohayo-100sc": ["ohayo 100 sc", "thuoc ohayo 100 sc", "ohayo 100sc"],
    "ohayo-240sc": ["ohayo 240 sc", "thuoc ohayo 240 sc", "ohayo 240sc"],
    "onehope": ["onehope", "thuoc onehope"],
    "onehope-480sl": ["onehope 480sl" ,"onehope 480 sl", "thuoc onehope 480 sl"],
    ...
    "sanbang-30sc": ["thuoc sanbang", "thuoc sanbang 30sc", "sanbang"],
    ...
    "sinapy-ram": ["thuoc sinapy", "thuoc sinapy ram", "sinapy", "sinapyram"],
    "sinapyram-80wg": ["thuoc sinapyram 80wg", "sinapy", "sinapyram"],
    "somethrin-10ec": ["thuoc somethrin", "thuoc somethrin 10ec", "somethrin"],
    "su-tu-do": ["thuoc su tu do", "su tu do"],
    "sulfur": ["luu huynh", "thuoc luu huynh", "sulfur"],
    ...
    "tamatras": ["thuoc tamatras", "tamatras"],
